function generateMadLib() {
  ...
  let storyHTML = `
    ...
    a significant challenge trying to  enter the company's “Doom Vault Database” that had locked itself.

    To get access back, and retrieve the mystery files, ${userName} needed too find the entry keys.
    ${userName} struggled to figure out the key, needing to look deep into the Doom Vault stored archives.
    ...
    ${userName} became known for skillfully solving complex challenges and mysteries connected to the entry of the DoomVault.
  `;
